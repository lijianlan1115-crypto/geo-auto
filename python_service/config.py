...
ANSWER_KEYWORD_STABLE_SECONDS = float(os.getenv("GEO_ANSWER_KEYWORD_STABLE_SECONDS", "2") or "2")
ANSWER_FINAL_SETTLE_SECONDS = float(os.getenv("GEO_ANSWER_FINAL_SETTLE_SECONDS", "2") or "2")
